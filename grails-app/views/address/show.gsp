            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="address.houseNumber.label" default="House Number" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: addressInstance, field: "houseNumber")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="address.flatNumber.label" default="Flat Number" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: addressInstance, field: "flatNumber")}</td>
